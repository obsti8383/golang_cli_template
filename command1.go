...
func Command1(arguments []string, configuration Configuration, errorLogger *log.Logger, debugLogger *log.Logger) int {
	// eval flags
	var help bool
	var verbose bool
	var pages int
	flags := flag.NewFlagSet("command1", flag.ContinueOnError)
